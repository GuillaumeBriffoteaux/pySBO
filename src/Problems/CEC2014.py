...
#-------------class CEC2014-------------#
#---------------------------------------#
class CEC2014(Mono_Objective):
    """Class for mono-objective problems from the CEC2014.
    ...
    def __init__(self, f_id, n_dvar):
        ...
        assert f_id>=1 and f_id<=30
        assert n_dvar==2 or n_dvar==10 or n_dvar==20 or n_dvar==30 or n_dvar==50 or n_dvar==100
        Mono_Objective.__init__(self, n_dvar, 1)
        self.__pb = pygmo.problem(pygmo.cec2014(f_id, n_dvar))
    ...
    #-------------_get_pb-------------#
    def _get_pb(self):
        print("[CEC2014.py] Impossible to get the Pygmo problem")
        return None

    #-------------_set_pb-------------#
    def _set_pb(self,new_pb):
        print("[CEC2014.py] Impossible to modify the Pygmo problem")

    #-------------_del_pb-------------#
    def _del_pb(self):
        print("[CEC2014.py] Impossible to delete the the Pygmo problem")
    ...
    #-------------plot-------------#
    def plot(self):
        """Plot the 2D CEC2014 considered problem's fitness function."""
        ...
        if self.n_dvar==2:
            ...
            print("[CEC2014.py] Impossible to plot CEC2014 with n_dvar="+str(self.n_dvar))
