...
class DTLZ(Multi_Objective):
    ...
    #-------------_get_pb-------------#
    def _get_pb(self):
        print("[DTLZ.py] Impossible to get the Pygmo problem")
        return self.__pb

    #-------------_set_pb-------------#
    def _set_pb(self,new_pb):
        print("[DTLZ.py] Impossible to modify the Pygmo problem")

    #-------------_del_pb-------------#
    def _del_pb(self):
        print("[DTLZ.py] Impossible to delete the the Pygmo problem")
