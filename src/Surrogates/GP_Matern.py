...
#---------------------------Defining Gaussian Process Matern kernel---------------------------#
...
class GP_Matern(Surrogate):
    ...
    def _get_likelihood(self):
        print("[GP_Matern.py] Impossible to modify the likelihood")
        return None
    ...
    def _del_likelihood(self):
        print("[GP_Matern.py] Impossible to delete the likelihood")

    #-------------_get_model-------------#
    def _get_model(self):
        print("[GP_Matern.py] Impossible to modify the model")
        return None
    ...
    #-------------_del_model-------------#
    def _del_model(self):
        print("[GP_Matern.py] Impossible to delete the model")
