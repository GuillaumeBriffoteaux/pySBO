...
.. autosummary::
   ...
   Evolution_Controls.Best_Predicted_EC.Best_Predicted_EC
   Evolution_Controls.Distance_EC.Distance_EC
   Evolution_Controls.Variance_EC.Variance_EC
...
Best-predicted
^^^^^^^^^^^^^^
.. autoclass:: Evolution_Controls.Best_Predicted_EC.Best_Predicted_EC
...
Variance
^^^^^^^^
.. autoclass:: Evolution_Controls.Variance_EC.Variance_EC
